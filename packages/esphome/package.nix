...
# Note: On macOS, some Linux-specific dependencies are excluded
# USB device access may be limited compared to Linux
...
python.pkgs.buildPythonApplication rec {
  ...
  pythonRemoveDeps = [
    ...
    # bleak doesn't build on macOS due to libudev-zero dependency
    "bleak"
  ];
